...
Currently, the following versions of **OmniAgent** are receiving security updates:
...
We take security seriously. Once a vulnerability is responsibly disclosed:
* We will investigate and verify the report.
* We will provide credit to the researcher (if desired).
* We will release a patch and update the repository metadata.

---
*Created for the OmniAgent Community.*
